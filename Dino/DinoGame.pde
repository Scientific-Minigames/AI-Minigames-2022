...
int obstacleTimer = 0;
int minimumTimeBetweenObstacles = 40; // KHOOBE
...
void writeInfo() {
  ...
  if (showBestEachGen) { //if showing the best for each gen then write the applicable info
    ...
    textSize(50);
    int x = 570;
    text("Distace to next obstacle", x, 105+44.44444);
    ...
    textSize(50);
    int x = 570;
    text("Distace to next obstacle", x, 94.44444);
    //text("Height of obstacle", x, 18+2*44.44444);
    //text("Width of obstacle", x, 18+3*44.44444);
    text("Bird height", x, 94.44444+82);
    text("Speed", x, 94.44444+2 * 82);
    //text("Players Y position", x, 18+6*44.44444);
    //text("Gap between obstacles", x, 18+7*44.44444);
    text("Bias", x, 94.44444+3 * 82);

    textAlign(LEFT);
    text("Small Jump", 1230, 120);
    text("Big Jump", 1230, 220);
    text("Duck", 1230, 320);
  }
}
